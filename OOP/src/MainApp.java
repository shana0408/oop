...
public class MainApp
{
	...
	private static void printMenu()
	{
		...
		System.out.println("6.  Check available slot in a course.");
		System.out.println("7.  Print student list for a course.");
		System.out.println("8.  Set course assessment components weightage.");
		System.out.println("9.  Enter coursework mark for a student.");
		System.out.println("10. Enter exam mark for a student.");
		System.out.println("11. Print course statistics.");
		System.out.println("12. Print student transcript.");
		System.out.println("13. View staff list in database.");
		System.out.println("14. View student list in database.");
		System.out.println("15. View module list in database.");
		System.out.println("16. View course list in database.");
